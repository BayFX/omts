...
fn sensitivity_str(s: &omtsf_core::enums::Sensitivity) -> &'static str {
    match s {
        omtsf_core::enums::Sensitivity::Public => "public",
        omtsf_core::enums::Sensitivity::Restricted => "restricted",
        omtsf_core::enums::Sensitivity::Confidential => "confidential",
    }
}

fn verification_status_str(s: &omtsf_core::enums::VerificationStatus) -> &'static str {
    match s {
        omtsf_core::enums::VerificationStatus::Verified => "verified",
        omtsf_core::enums::VerificationStatus::Reported => "reported",
        omtsf_core::enums::VerificationStatus::Inferred => "inferred",
        omtsf_core::enums::VerificationStatus::Unverified => "unverified",
    }
}
