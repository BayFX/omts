//! Integration tests for `omts export`.
...
fn export_nonexistent_input_exits_2() {
    ...
    let out = Command::new(omts_bin())
        ...
        .output()
        .expect("run omts export (missing input)");
...
fn export_explicit_format_excel_exits_0() {
    ...
    let out = Command::new(omts_bin())
        ...
        .output()
        .expect("run omts export --output-format excel");
...
fn export_full_featured_omts_exits_0() {
    ...
    let out = Command::new(omts_bin())
        ...
        .output()
        .expect("run omts export full-featured.omts");
...
/// Parses a `nodes: N` or `edges: N` line from `omts query --count` output.
...
fn query_count(path: &std::path::Path) -> u64 {
    let out = Command::new(omts_bin())
        ...
        .output()
        .expect("run omts query --count nodes");
...
fn export_supplier_list_round_trip() {
    ...
    let import_out = Command::new(omts_bin())
        ...
        .output()
        .expect("run omts import supplier list");
    ...
    let export_out = Command::new(omts_bin())
        ...
        .output()
        .expect("run omts export supplier list");
    ...
    let reimport_out = Command::new(omts_bin())
        ...
        .output()
        .expect("run omts re-import supplier list");
...
fn export_unknown_format_exits_2() {
    ...
    let out = Command::new(omts_bin())
        ...
        .output()
        .expect("run omts export --output-format foobar");
...
fn query_edge_count(path: &std::path::Path) -> u64 {
    let out = Command::new(omts_bin())
        ...
        .output()
        .expect("run omts query --count edges");
    let stdout = String::from_utf8_lossy(&out.stdout);
