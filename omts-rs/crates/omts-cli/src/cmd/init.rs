...
fn build_minimal_file(
    ...
    salt: omts_core::newtypes::FileSalt,
) -> Result<OmtsFile, String> {
    Ok(OmtsFile {
        omts_version: version,
        snapshot_date,
        file_salt: salt,
