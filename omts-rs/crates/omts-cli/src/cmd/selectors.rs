...
//! [`omts_core::graph::selector_match`] and
//! [`omts_core::graph::selector_subgraph`].
//!
//! # Parsing Rules
//!
...
use omts_core::graph::selectors::{Selector, SelectorSet};
use omts_core::{CountryCode, EdgeTypeTag, NodeTypeTag};
...
mod tests {
    ...
    use omts_core::{EdgeType, EdgeTypeTag, NodeType, NodeTypeTag};
