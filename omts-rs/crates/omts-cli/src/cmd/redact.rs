//! Implementation of `omts redact <file> --scope <scope>`.
//!
...
use omts_core::redact;
use omts_core::{DisclosureScope as CoreScope, OmtsFile, enums::NodeType, enums::NodeTypeTag};
