...
///
/// This module implements two output strategies for [`omts_core::Diagnostic`]
/// values:
///
...
use omts_core::{Diagnostic, Severity};
...
mod tests {
    ...
    use omts_core::{Diagnostic, Location, RuleId, Severity};
