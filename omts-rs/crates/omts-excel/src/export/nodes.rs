...
use omts_core::types::{Identifier, Label};
...
fn write_facility_row(worksheet: &mut Worksheet, row: u32, node: &Node) -> Result<(), ExportError> {
    ...
    if let Some(geo_val) = &node.geo {
        if let Some(obj) = geo_val.as_object() {
            if let Some(lat) = obj.get("lat").and_then(omts_core::DynValue::as_f64) {
                wf64(worksheet, row, 4, lat)?;
            }
            if let Some(lon) = obj.get("lon").and_then(omts_core::DynValue::as_f64) {
...
fn org_status_str(s: &omts_core::enums::OrganizationStatus) -> &'static str {
    match s {
        omts_core::enums::OrganizationStatus::Active => "active",
        omts_core::enums::OrganizationStatus::Dissolved => "dissolved",
        omts_core::enums::OrganizationStatus::Merged => "merged",
        omts_core::enums::OrganizationStatus::Suspended => "suspended",
    }
}

fn attestation_type_str(s: &omts_core::enums::AttestationType) -> &'static str {
    match s {
        omts_core::enums::AttestationType::Certification => "certification",
        omts_core::enums::AttestationType::Audit => "audit",
        omts_core::enums::AttestationType::DueDiligenceStatement => "due_diligence_statement",
        omts_core::enums::AttestationType::SelfDeclaration => "self_declaration",
        omts_core::enums::AttestationType::Other => "other",
    }
}

fn attestation_outcome_str(s: &omts_core::enums::AttestationOutcome) -> &'static str {
    match s {
        omts_core::enums::AttestationOutcome::Pass => "pass",
        omts_core::enums::AttestationOutcome::ConditionalPass => "conditional_pass",
        omts_core::enums::AttestationOutcome::Fail => "fail",
        omts_core::enums::AttestationOutcome::Pending => "pending",
        omts_core::enums::AttestationOutcome::NotApplicable => "not_applicable",
    }
}

fn attestation_status_str(s: &omts_core::enums::AttestationStatus) -> &'static str {
    match s {
        omts_core::enums::AttestationStatus::Active => "active",
        omts_core::enums::AttestationStatus::Suspended => "suspended",
        omts_core::enums::AttestationStatus::Revoked => "revoked",
        omts_core::enums::AttestationStatus::Expired => "expired",
        omts_core::enums::AttestationStatus::Withdrawn => "withdrawn",
    }
}

fn risk_severity_str(s: &omts_core::enums::RiskSeverity) -> &'static str {
    match s {
        omts_core::enums::RiskSeverity::Critical => "critical",
        omts_core::enums::RiskSeverity::High => "high",
        omts_core::enums::RiskSeverity::Medium => "medium",
        omts_core::enums::RiskSeverity::Low => "low",
    }
}

fn risk_likelihood_str(s: &omts_core::enums::RiskLikelihood) -> &'static str {
    match s {
        omts_core::enums::RiskLikelihood::VeryLikely => "very_likely",
        omts_core::enums::RiskLikelihood::Likely => "likely",
        omts_core::enums::RiskLikelihood::Possible => "possible",
        omts_core::enums::RiskLikelihood::Unlikely => "unlikely",
    }
}
