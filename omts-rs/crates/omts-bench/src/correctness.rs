...
use omts_core::diff::DiffResult;
use omts_core::file::OmtsFile;
use omts_core::graph::OmtsGraph;
...
pub fn check_redaction(
    output: &OmtsFile,
    target_scope: &omts_core::enums::DisclosureScope,
) -> Result<(), String> {
    use omts_core::enums::{DisclosureScope, NodeType, NodeTypeTag};
