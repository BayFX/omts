...
//! parses it with [`omts_core::parse_omts`], and asserts that the result is
...
use omts_core::{Encoding, OmtsFile, parse_omts};
...
fn cbor_extension_types_preserves_extension_type_tags() {
    use omts_core::enums::{EdgeTypeTag, NodeTypeTag};
