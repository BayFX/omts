...
/// Merges two or more OMTS files into a single deduplicated file.
///
...
/// Merges two or more OMTS files using the given configuration.
///
/// # Errors
///
/// See [`merge`].
pub fn merge_with_config(
    ...
    let omts_version = files[0].omts_version.clone();
