...
/// - The original header fields (`omts_version`, `snapshot_date`,
...
///
/// Intended for the `omts query` command, which displays matches without
...
fn assemble_subgraph(
    ...
    Ok(OmtsFile {
        omts_version: file.omts_version.clone(),
