/// All enums defined in the OMTS graph data model (SPEC-001 Sections 4.1–4.4).
///
...
/// Known node types defined by the OMTS core specification (SPEC-001 Section 4).
#[derive(Debug, Clone, PartialEq, Eq, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum NodeType {
...
pub enum NodeTypeTag {
    /// A node type recognised by this version of omts-core.
    Known(NodeType),
...
/// Known edge types defined by the OMTS core specification (SPEC-001 Sections 5-7).
#[derive(Debug, Clone, PartialEq, Eq, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum EdgeType {
...
pub enum EdgeTypeTag {
    /// An edge type recognised by this version of omts-core.
    Known(EdgeType),
